		...
		<div class=" admin-content">
			...
			<div class="admin">
				<div class="admin-biaoge">
					...
					<%
						book book=(book)request.getSession().getAttribute("AdminBook");
					%>
					<form action="${pageContext.request.contextPath }/Admin/Book/AdminUpdateBook"
						method="post" onsubmit="return checkForm();">
						<div class="form_row">
							<input type="hidden" value="<%=book.getBook_id() %>" name="book_id"/>
							<label class="contact"><strong>书名:</strong></label> <input
								type="text" class="contact_input" name="book_name" id="bookname" value="<%=book.getBook_name() %>"/>
						</div>
						<div class="form_row">
							<label class="contact"><strong>图书类型:</strong></label> <input
								type="text" class="contact_input" name="book_value" id="typeid" value="<%=book.getBook_value() %>"/>
								<div class="terms">必填项,请填数据库中存在的类型</div>
						</div>
						<div class="form_row">
							<label class="contact"><strong>作者:</strong></label> <input
								type="text" class="contact_input" name="book_author" id="author" value="<%=book.getBook_author() %>"/>
						</div>
						<div class="form_row">
							<label class="contact"><strong>出版社:</strong></label> <input
								type="text" class="contact_input" name="book_press"
								id="publisher" value="<%=book.getBook_press() %>"/>
						</div>
						<div class="form_row">
							<label class="contact"><strong>价格:</strong></label> <input
								type="text" class="contact_input" name="book_price" id="price" value="<%=book.getBook_price() %>"/>
						</div>
						<div class="form_row">
							<label class="contact"><strong>内容:</strong></label> <input
								type="text" class="contact_input" name="book_Introduction" id="description" value="<%=book.getBook_introduction() %>"/>
						</div>
						<div class="form_row">
							<label class="contact"><strong>装裱方式:</strong></label> <input
								type="text" class="contact_input" name="book_packing" value="<%=book.getBook_packing() %>"/>
						</div>
						<div class="form_row">
							<label class="contact"><strong>ISBN:</strong></label> <input
								type="text" class="contact_input" name="book_ISBN" value="<%=book.getBook_ISBN() %>"/>
						</div>
						<div class="form_row">
							<label class="contact"><strong>页数:</strong></label> <input
								type="text" class="contact_input" name="book_page_number" value="<%=book.getBook_pages_number() %>"/>
						</div>
						<div class="form_row">
							<label class="contact"><strong>书开:</strong></label> <input
								type="text" class="contact_input" name="book_folie" value="<%=book.getBook_folie() %>"/>
						</div>
						<div class="form_row">
							<label class="contact"><strong>图片地址:</strong></label> <input
								type="text" class="contact_input" name="book_image" id="imgurl" value="<%=book.getBook_image() %>"/>
						</div>
						<div class="form_row">
							<label class="contact"><strong>小图片地址:</strong></label> <input
								type="text" class="contact_input" name="book_img_min" value="<%=book.getBook_img_min() %>"/>
						</div>
						<div class="form_row">
							<label class="contact"><strong>详情图片地址:</strong></label> <input
								type="text" class="contact_input" name="book_introduction_img" value="<%=book.getBook_introduction_img() %>"/>
						</div>
						<div class="form_row">
