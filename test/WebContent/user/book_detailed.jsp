						...
						<div id="preview">
							<div id="spec-n1" class="jqzoom">
								...
								<img width="350" height="350"
									src="${path }book_0_test/567d207aNae55c8da.jpg" />
							</div>
										...
										<div id="choose-attr-1" class="li p-choose">
											...
											<div class="dd">
												<div class="item" title="龙族1：火之晨曦">
													<b></b> <a href=""> <img
														src="${path }book_0_test/5680f66fN4739e275.jpg"
														...
														<div class="book-detail-content">
															<p>
																<img title="11827512_2.jpg" width="750" height="1014"
																	src="${path }book_0_test/59f1337eNa89b1669.jpg" />
															</p>
														</div>
													</div>
												</div>
											...
											<div class="J-p-show-img p-show-img clearfix"
												...
												<ul class="clearfix">
													...
													<li><div class="J-show-more-pic">
															<img
																src="${path }book_0_test/563e06b9Nbf2cd707.jpg"
																alt="1***p 的晒单图片"/>
														</div></li>
													<!--2-->
													<!--0-->
													<li><div class="J-show-more-pic">
															<img
																src="${path }book_0_test/563e06bbN53eea3a9.jpg"
																alt="1***p 的晒单图片"/>
														</div></li>
													<!--3-->
													<!--0-->
													<li><div class="J-show-more-pic">
															<img
																src="${path }book_0_test/563e06bcNd70678a0.jpg"
																alt="1***p 的晒单图片"/>
														</div></li>
													<!--4-->
													<!--0-->
													<li><div class="J-show-more-pic">
															<img
																src="${path }book_0_test/563e06bcN4887df73.jpg"
																alt="1***p 的晒单图片"/>
														</div></li>
													<!--5-->
													<!--0-->
													<li><div class="J-show-more-pic">
															<img
																src="${path }book_0_test/563e06bdN06b167b7.jpg"
																alt="1***p 的晒单图片"/>
														</div></li>
													<!--6-->
													<!--0-->
