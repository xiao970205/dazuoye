...
<%
	...
	if(book==null){
		response.sendRedirect("/homework_0/user/index.jsp");
	}
%>
<body>
								...
								<div id="choose-btns" class="li">
									...
									<form action="">
										<div class="choose-amount fl ">
												<a class="btn-reduce disabled" onclick="jian2s()">-</a>
												<a class="btn-add" onclick="j2s()">+</a> 
												<input class="text" id="test" value="1"/>
										</div>
										<!-- 加入购物车 -->
